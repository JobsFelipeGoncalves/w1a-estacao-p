...
<html lang="pt-br">
  <head>
    ...
    <title>Parceiros - Gerencie Mais :: <?= $NOME_CLIENT ?></title>
  </head>
...
?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-md-3 mb-2">
                        <a href="parceiros_.php?funcao=novo&urlRetorno=<?= $URL_ATUAL ?>" class = "botao botao-a-min b-pequeno float-end">Criar um novo</a>
                    </div>
                </div>
                ...
                ?>
                        ...
                        <div class="row ">
                            <div class="col-sm-9">
                                ...
                                <ul class="nav abas-navegacao">
                                  <li class="nav-item">
                                    <a class="nav-link <?= $abaAtual == "publicado" ? "active" : ""; ?>" href="parceiros.php?aba=publicado&acao=lista">Publicados</a>
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link <?= $abaAtual == "lixeira" ? "active" : ""; ?>" href="parceiros.php?aba=lixeira&acao=lista">Lixeira</a>
                                  </li>
                                </ul>
                    ...
                    $inicio =  ($limiteRegistro * $paginaRecebida) - $limiteRegistro;
                        ...
                        $seleciona = "SELECT * FROM parceiros WHERE status = '$abaAtual' ORDER BY ordem DESC LIMIT $inicio, $limiteRegistro  ";
                            ...
                            <div class="col col-sm-1">
                                <div class="dropdown ">
                                      ...
                                      <ul class="dropdown-menu f-14">
                                        <li><a class="dropdown-item" href="parceiros_.php?funcao=editar&id=<?= $registo['id'] ?>&urlRetorno=<?= $URL_ATUAL ?>">Editar</a></li>
                                        <?php if($abaAtual != "lixeira"){ ?> 
                                        <li><a class="dropdown-item" href="parceiros.php?botao=lixeira&id=<?= $registo['id'] ?>&urlRetorno=<?= $URL_ATUAL ?>">Mover para o lixo</a></li>
                                        <?php }elseif($abaAtual == "lixeira"){ ?> 
                                        <li><a class="dropdown-item" href="parceiros.php?botao=restaurar&id=<?= $registo['id'] ?>&urlRetorno=<?= $URL_ATUAL ?>">Restaurar</a></li>
                                                  ...
                                                  <div class="modal-header">
                                                    ...
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                      ...
                                                      <div class="modal-footer">
                                                        ...
                                                        <a href="parceiros.php?botao=excluir&id=<?= $registo['id'] ?>&urlRetorno=<?= $URL_ATUAL ?>" type="button" class="botao b-pequeno botao-a-min">Sim! Excluir.</a>
                                                      </div>
                                                </div>
                                              </div>
                                            </div>
                   ...
                   <!-- caso esteja vazio -->
                    ...
                    ?>
                       ...
                       <div class="centro p-5">                        
                            ...
                            <a href="parceiros_.php?funcao=novo&urlRetorno=<?= $URL_ATUAL ?>" class = "botao botao-a-min b-pequeno">Adicione agora</a><br>
                    ...
                    <nav class = "gm-paginacao mt-4">
                      <ul class="pagination pagination-sm justify-content-end">
                        <?php                        
                            ...
                            $contaRegisto = "SELECT COUNT(id) AS numeroAchado FROM parceiros";
  ...
  //Edicao dos botoes
        ...
        if (isset($_GET['botao'])) {
            ...
            if ($acaoBotao == "lixeira") {
                //========
                $selecionaAcao = "UPDATE parceiros SET status = 'lixeira' WHERE id = '$acoRotativo'";
            ...
            if ($acaoBotao == "restaurar") {
               ...
               // echo "Ok! Vamos ocultar conteúdo";
                $selecionaAcao = "UPDATE parceiros SET status = 'publicado' WHERE id = '$acoRotativo'";
                $consultaAcao = $conexao -> prepare($selecionaAcao);
                $consultaAcao -> execute();
            ...
            if ($acaoBotao == "excluir") {
                ...
                // echo "Ok! Vamos ocultar conteúdo";
                $selecionaAcao = "DELETE FROM parceiros WHERE id = '$acoRotativo'";
                $consultaAcao = $conexao -> prepare($selecionaAcao);
                $consultaAcao -> execute();
