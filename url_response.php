...
if (!defined('BASE')) {
  define('BASE', 'http://localhost/projeto'); # url raiz do projeto
  //define('BASE','http://www.estacaop.com.br/');
}
...
if (!defined('PROJECT_DIR'))
  define('PROJECT_DIR', 'w1agencia/estacao-p'); #pasta raiz do projeto
